...
class Staff (models.Model):
    STATES = (('Andhra Pradesh','Andhra Pradesh'),('Arunachal Pradesh','Arunachal Pradesh'),('Assam','Assam'),('Bihar','Bihar'),('Goa','Goa'),
        ('Gujarat','Gujarat'),('Haryana','Haryana'),('Himachal Pradesh','Himachal Pradesh'),('Jharkhand','Jharkhand'),('Karnataka','Karnataka'),('Kerala','Kerala'),('Madhya Pradesh','Madhya Pradesh'),('Maharashtra','Maharashtra'),('Meghalaya','Meghalaya'),
              ('Nagaland','Nagaland'),('Odisha','Odisha'),('Punjab','Punjab'),('Tamil Nadu','Tamil Nadu'),('Telangana','Telangana'),)
    image = models.ImageField(blank=True)
    first_name = models.CharField(max_length=20)
    last_name = models.CharField(max_length=20)
    stipend = models.CharField(max_length=10)
    mobile_number = models.CharField(max_length=11)
    state = models.CharField(max_length=20, choices=STATES, default='Andhra Pradesh')
